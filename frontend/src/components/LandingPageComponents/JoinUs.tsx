  ...
  return (
    <>
      ...
      <div className='sm:hidden w-screen'>
        <div className='font-exo flex flex-col items-center gap-6 text-white w-[80%] mx-auto bg-gradient-to-br from-slate-100/10 to-slate-400/10 rounded-lg py-4'>
          <h2 className='text-xl font-bold'>Join Us</h2>
          <div className='flex flex-col items-center justify-center gap-8'>
            <img src={JoinImage} className='w-32' />
            <div>
              <form className='flex flex-col items-center gap-4'>
                <input placeholder='Enter Email' className='text-sm p-2 bg-transparent border-2 border-slate-100/50 rounded-lg' />
                <button className='bg-red-600 text-white text-sm px-8 py-2 rounded-lg'>Join</button>
              </form>
            </div>
          </div>
        </div>
