...
const TestimonialCard = ({test} : TestProps) => {
    return (
        <div className='w-[300px] bg-slate-100/10 p-6 rounded-lg text-stone-300 font-medium flex flex-col justify-between gap-8'>
            <div className='p-0'>
                <p>{test.message}</p>
            </div>
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex gap-4 items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-sm font-semibold text-stone-200/50'>{test.user.tag_name}</p>
                    </div>
                </div>
            </div>
        </div>
